...
$TableVideos = "SELECT * FROM articles LEFT JOIN categories ON articles.categorie_video = categories.id_categorie WHERE id_categorie = '1' AND publier = 'oui'";
...
<div class="container">
 <div class="panel panel-default" style="background-image: url(http://payload255.cargocollective.com/1/7/252953/7407270/_Stromae_860.png);">
...
?>
    ...
    $requete = "SELECT * FROM articles LEFT JOIN categories ON articles.categorie_video = categories.id_categorie WHERE id_categorie = '1'";
    ...
    //Going to first page
    echo '<center><ul class="pagination" style="margin-bottom: 140px; color:black;"><li><span><a href="index.php?page=1">Premiere Page</a></span></li>';
    ...
    // Going to last page
    echo "<li><span><a href=index.php?page=$total_pages>Derniere Page</a></span></li>";
    ?>
</div>
