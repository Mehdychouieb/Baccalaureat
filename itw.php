    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="itw.php">Interviews</a> </li>
...
$TableVideos = "SELECT * FROM articles LEFT JOIN categories ON articles.categorie_video = categories.id_categorie WHERE id_categorie = '2' AND publier = 'oui'";
...
?>
    ...
    <div class="container">
        <div class="panel panel-default" style="background-image: url(http://66.media.tumblr.com/8d2f3c336c76062a820cb30c814c91fe/tumblr_nuid79A6131r46py4o1_500.png);">
...
<div>
    ...
    $requete = "SELECT * FROM articles LEFT JOIN categories ON articles.categorie_video = categories.id_categorie WHERE id_categorie = '2'";
